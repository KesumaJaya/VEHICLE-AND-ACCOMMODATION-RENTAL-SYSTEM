public class Vehicle extends Renter
{
    ...
    public double calcPrice() // Set vehicle name, vehicle price and return total price including 7% tax
    {
        switch(rentalType)
        {
            case 'H': // set price for rent by hour
            if(super.getCompany().getCompanyName().equals("SwiftDrive"))
             {
            ...
            else if(super.getCompany().getCompanyName().equals("CarrierGo"))  
            {
            ...
            case 'D': // set price for rent by day
            if(super.getCompany().getCompanyName().equals("SwiftDrive"))
            {
                if(vehicleType == 'C' && vehicleModel == 'S')
                {
            ...
            else if(super.getCompany().getCompanyName().equals("BigWheels"))
            {
                if(vehicleModel == 'F')
                {
